...
2. Add new line "<Item>dlcpacks:\bcss\</Item>" to dlclist.xml
3. Save, and replace the old one at ------> \update\update.rpf\common\data

[dlc data part 2]
1. Create a folder under \mods\update\x64\dlcpacks\ called "bcss"
...
2017 Shelby SuperSnake F-150 --------> Type this name: bcss