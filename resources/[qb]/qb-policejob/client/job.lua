        ...
        for k, v in pairs(Config.Locations["stash"]) do
            exports['qb-target']:AddBoxZone("Stash_"..k, vector3(v.x, v.y, v.z), 1, 1, {
                ...
                options = {
                    {
                        type = "client",
                        event = "police:client:openPStash",
...
CreateThread(function ()
    ...
    while true do
        for k, v in pairs(Config.Locations["trash"]) do
            exports['qb-target']:AddBoxZone("Trash_"..k, vector3(v.x, v.y, v.z), 1, 1, {
                name = "Trash"..k,
                heading = 11,
                debugPoly = false,
                minZ = v.z - 1,
...
CreateThread(function ()
    ...
    while true do
        for k, v in pairs(Config.Locations["fingerprint"]) do
            exports['qb-target']:AddBoxZone("Fingerprint_"..k, vector3(v.x, v.y, v.z), 1, 1, {
                name = "Fingerprint"..k,
                heading = 11,
                debugPoly = false,
                minZ = v.z - 1,
