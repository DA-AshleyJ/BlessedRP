...
RegisterNetEvent('qb-customs:server:attemptPurchase', function(type, upgradeLevel)
	...
	exports['qb-bossmenu']:AddMoney("mechanic", repairCost)
        else
	...
	exports['qb-bossmenu']:AddMoney("mechanic", vehicleCustomisationPrices[type].prices[upgradeLevel])
        else
            TriggerClientEvent('qb-customs:client:purchaseFailed', source)
        end
    else
	...
	exports['qb-bossmenu']:AddMoney("mechanic", vehicleCustomisationPrices[type].price)
        else
            TriggerClientEvent('qb-customs:client:purchaseFailed', source)
        end
    end
