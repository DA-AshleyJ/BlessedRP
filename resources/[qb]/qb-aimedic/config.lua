...
Config.MinOnLineDoktors  = 1                   -- How many ambulance jobs have to be online to make this work, you can set this to 0 if you have a huge server and les time to get to players.
