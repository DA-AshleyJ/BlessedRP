...
--Threads
RegisterNetEvent("consumables:client:OpenMEatCMenu", function(itemName)
    QBCore.Functions.Progressbar("eat_something", "Package Opening", 15000, false, false, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
