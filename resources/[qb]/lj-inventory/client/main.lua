...
RegisterNUICallback("CloseInventory", function(data)
    ...
    elseif CurrentStash ~= nil then
        TriggerServerEvent("inventory:server:SaveInventory", "stash", CurrentStash, data)
        CurrentStash = nil
    else
...
local craftitemfirst = false

RegisterNUICallback("CraftItem", function()
    craftitemfirst = true
end)

RegisterNetEvent('inventory:client:transferdatacrafting', function(item)
    TriggerEvent('WM-Crafting:Client:CraftItem', craftitemfirst, item)
    Wait(1000)
    craftitemfirst = false
end)
...
RegisterCommand('license', function(item)
    local item = "drivers_license"
...
RegisterNUICallback("SetInventoryData", function(data)
    curcraftt = data.curcraft
    TriggerServerEvent("inventory:server:SetInventoryData", data.fromInventory, data.toInventory, data.fromSlot, data.toSlot, data.fromAmount, data.toAmount, curcraftt)
end)
