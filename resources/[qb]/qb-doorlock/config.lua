...
-- Back Entrance
		...
		-- To Garage
	{
		objName = 1830360419,
		objYaw = 90,
		objCoords  = vector3(464.16, -974.67, 26.37),
		textCoords = vector3(464.76, -976.01, 26.27),
		authorizedJobs = { 'police' },
		locked = true,
		pickable = false,
		distance = 2.0
	...
	
	{
		objHash = -1868050792,
		objHeading = 270.0,
		objCoords = vector3(410.03, -1024.22, 29.22),
		authorizedJobs = { ['police']=0 },
		locked = true,
		garage = true,
		slides = true,
		maxDistance = 8.0,
		textCoords = vector3(414.13, -1024.01, 29.5),
