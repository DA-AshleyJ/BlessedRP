        ...
        if math.random() <= chance then
            ...
            if closestPed ~= nil then
                ...
                if IsPedInAnyVehicle(ped) then
                    ...
                    TriggerServerEvent("core_dispatch:addCall", "10-99", "CarJacking In Progress", {{icon = "fa-solid fa-car", info = modelName},{icon = "fa-solid fa-align-left", info = modelPlate}}, {alertCoords[1], alertCoords[2], alertCoords[3]}, "police", 10000, 110, 79)
                else
...
local function Hotwire()
    if not HasVehicleKey then
        ...
        PoliceCall()
        QBCore.Functions.Progressbar("hotwire_vehicle", "Hotwiring the car!", hotwireTime, false, true, {
