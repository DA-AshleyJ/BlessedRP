...
Config.Prices = {
	['copper'] = { name = 'copper', amount = 5 },
	['plastic'] = { name = 'plastic', amount = 5 },
	['metalscrap'] = { name = 'metalscrap', amount = 5 },
	['steel'] = { name = 'steel', amount = 5 },
	['glass'] = { name = 'glass', amount = 5 },
	['iron'] = { name = 'iron', amount = 5 },
	['rubber'] = { name = 'rubber', amount = 5 },
	['aluminum'] = { name = 'aluminium', amount = 5 },
	['bottle'] = { name = 'bottle', amount = 2 },
	['can'] = { name = 'bottle', amount = 2 },
}
