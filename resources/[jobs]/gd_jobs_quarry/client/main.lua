...
RegisterNetEvent('quarry:spawn')
AddEventHandler('quarry:spawn', function(pd)
    local veh = "rubble"
    local coords = vector4(2573.55, 2712.21, 42.33, 290.72) -- 431.32, -984.99, 25.7
    QBCore.Functions.SpawnVehicle(veh, function(veh)
        SetVehicleNumberPlateText(veh, "Quarry")
