...
RegisterNetEvent('bus:spawn')
AddEventHandler('bus:spawn', function(pd)
    local veh = "bus"
    local coords = vector4(-364.01, 6078.08, 31.49, 140.24) -- 431.32, -984.99, 25.7
    QBCore.Functions.SpawnVehicle(veh, function(veh)
        SetVehicleNumberPlateText(veh, "BUS")
...
RegisterNetEvent('bus:spawnbase')
AddEventHandler('bus:spawnbase', function(pd)
    local veh = "bus"
    local coords = vector4(-2334.01, 3256.13, 32.83, 238.73) -- 431.32, -984.99, 25.7
    QBCore.Functions.SpawnVehicle(veh, function(veh)
        SetVehicleNumberPlateText(veh, "BUS2")
        exports['LegacyFuel']:SetFuel(veh, 100.0)
        TaskWarpPedIntoVehicle(PlayerPedId(), veh, -1)
        TriggerEvent("vehiclekeys:client:SetOwner", QBCore.Functions.GetPlate(veh))
        SetVehicleEngineOn(veh, true, true)
...
RegisterNetEvent('bus:spawnsandy')
AddEventHandler('bus:spawnsandy', function(pd)
    local veh = "bus"
    local coords = vector4(1957.33, 3764.63, 32.2, 118.6) -- 431.32, -984.99, 25.7
    QBCore.Functions.SpawnVehicle(veh, function(veh)
        SetVehicleNumberPlateText(veh, "BUS3")
        exports['LegacyFuel']:SetFuel(veh, 100.0)
        TaskWarpPedIntoVehicle(PlayerPedId(), veh, -1)
        TriggerEvent("vehiclekeys:client:SetOwner", QBCore.Functions.GetPlate(veh))
        SetVehicleEngineOn(veh, true, true)
...
RegisterNetEvent('bus:spawncity')
AddEventHandler('bus:spawncity', function(pd)
    local veh = "bus"
    local coords = vector4(468.04, -620.55, 28.5, 352.24) -- 431.32, -984.99, 25.7
    QBCore.Functions.SpawnVehicle(veh, function(veh)
        SetVehicleNumberPlateText(veh, "BUS4")
        exports['LegacyFuel']:SetFuel(veh, 100.0)
        TaskWarpPedIntoVehicle(PlayerPedId(), veh, -1)
        TriggerEvent("vehiclekeys:client:SetOwner", QBCore.Functions.GetPlate(veh))
        SetVehicleEngineOn(veh, true, true)
...
RegisterNetEvent('bus:spawncoach')
AddEventHandler('bus:spawncoach', function(pd)
    local veh = "coach"
    local coords = vector4(468.04, -620.55, 28.5, 352.24) -- 431.32, -984.99, 25.7
    QBCore.Functions.SpawnVehicle(veh, function(veh)
        SetVehicleNumberPlateText(veh, "COACH1")
        exports['LegacyFuel']:SetFuel(veh, 100.0)
        TaskWarpPedIntoVehicle(PlayerPedId(), veh, -1)
        TriggerEvent("vehiclekeys:client:SetOwner", QBCore.Functions.GetPlate(veh))
        SetVehicleEngineOn(veh, true, true)
