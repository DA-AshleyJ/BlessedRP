...
RegisterServerEvent('qb-speedcamera:Payrepair') -- Pay Repairs
AddEventHandler('qb-speedcamera:Payrepair', function()
	local xPlayer = QBCore.Functions.GetPlayer(source)
	local totalAmount = 2000 -- Change me to charge less/more
	xPlayer.Functions.RemoveMoney("bank", totalAmount)
end)
